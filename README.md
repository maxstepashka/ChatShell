...
2) Библиотека "keyboard" от boppreh. Ссылка на профиль автора: https://github.com/boppreh

* Создатель ChatShell не присваивает себе авторства над репозиториями, которые перечислены выше. Авторские права, оформленные на авторов библиотек находятся в их (библиотек) папках.